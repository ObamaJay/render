...
def sanitize_text(text: str) -> str:
    # normalize Unicode punctuation to ASCII so core fonts won't choke
    text = (text or "")
    text = (text
...
class PDF(FPDF):
    """
    Adds a clean footer on every page:
    ...
    def footer(self):
        ...
        # Page X of N uses alias {nb} (set via alias_nb_pages())
...
def stripe_webhook():
    ...
    try:
        ...
        try:
            ...
            print("⚠️ Could not update lead:", e)

        # Optional: log payment
        amount = session.get("amount_total") or 1900
