...
def add_footer(pdf: FPDF):
    ...
    pdf.cell(0, 6, "Generated by ImmigrAI.org – Not affiliated with USCIS or the U.S. government.", ln=1, align="C")
...
<html>
  <body style="font-family: Arial, sans-serif; color:#333; line-height:1.6; max-width:600px; margin:auto; padding:20px; border:1px solid #eee; border-radius:8px;">
    ...
    <p>This checklist is based on the latest USCIS requirements to help ensure you don’t miss any documents in your application.</p>
    ...
    <p style="font-size:12px; color:#999; text-align:center;">
      Generated by ImmigrAI.org – Your immigration assistant.<br>
...
def build_email_text(download_link: str, visa_type: str) -> str:
    return (
        ...
        "Thank you for using ImmigrAI. We’ve generated your personalized checklist.\n\n"
...
def stripe_webhook():
    ...
    try:
        ...
        try:
            ...
            print("⚠️ Could not update lead with pdf_object/emailed_at:", e)
